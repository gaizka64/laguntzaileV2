 ...
 */
class Poste extends \laguntzaile\BenevolesBundle\Entity\Poste implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'laguntzaile\\BenevolesBundle\\Entity\\Poste' . "\0" . 'id', '' . "\0" . 'laguntzaile\\BenevolesBundle\\Entity\\Poste' . "\0" . 'nom', '' . "\0" . 'laguntzaile\\BenevolesBundle\\Entity\\Poste' . "\0" . 'description', '' . "\0" . 'laguntzaile\\BenevolesBundle\\Entity\\Poste' . "\0" . 'position', '' . "\0" . 'laguntzaile\\BenevolesBundle\\Entity\\Poste' . "\0" . 'idEvenement');
        }
