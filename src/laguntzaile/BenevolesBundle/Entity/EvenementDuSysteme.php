 ...
 * EvenementDuSysteme
 *
 * @ORM\Table(name="evenement_du_systeme", indexes={@ORM\Index(name="evenement_du_systeme_action_idx", columns={"action"}), @ORM\Index(name="IDX_F4DBA55FECCFAC24", columns={"id_affectation"}), @ORM\Index(name="IDX_F4DBA55F8B13D439", columns={"id_evenement"}), @ORM\Index(name="IDX_F4DBA55F5F15257A", columns={"id_personne"}), @ORM\Index(name="IDX_F4DBA55F920C4E9B", columns={"id_poste"}), @ORM\Index(name="IDX_F4DBA55FE1F1E56B", columns={"id_tour"}), @ORM\Index(name="IDX_F4DBA55F92921F4A", columns={"id_disponibilite"})})
 * @ORM\Entity
 */
